...
export default function HomeClient() {
  ...
  return (
    <main className="min-h-screen bg-[#070A12] text-[#EAF0FF]">
      ...
      <header className="sticky top-0 z-50 border-b border-white/10 bg-[#070A12]/80 backdrop-blur">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-4">
          ...
          <nav className="hidden items-center gap-6 text-sm text-[#9AA4BF] md:flex">
            ...
            <a className="hover:text-white" href="/orcamento">Orçamento</a>
      ...
      {/* Hero com imagem (mais leve, parecido com o antigo) */}
      <section className="relative overflow-hidden">
        <div className="absolute inset-0">
          <img
            ...
            loading="eager"
          />
          <div className="absolute inset-0 bg-gradient-to-b from-black/60 via-[#070A12]/75 to-[#070A12]" />
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <div className="mt-1 text-xs text-[#9AA4BF]">
                  Acompanhe projetos, chamados e alertas
                </div>
              </div>
